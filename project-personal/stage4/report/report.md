...
1. Я зарегистрировалась на необходимых ресурсах и добавила ссылки на них на сайт. (рис. [-@fig:001]).

![Ссылки](image/1.png){#fig:001 width=70%}

2. Я написала пост о прошедшей неделе.

![Пост](image/2.png){#fig:002 width=70%}

3. Я написала пост о создании презентаций.
